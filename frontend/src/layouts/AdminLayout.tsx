...
export default function AdminLayout() {
  ...
  const navItems = [
    ...
    { path: '/admin/applications', icon: FileText, label: 'Hakemukset' },
    ...
    { path: '/admin/users', icon: Users, label: 'Käyttäjät' },
  ];
          ...
          <div className="p-4 border-t border-white/10">
            <div className="flex items-center space-x-3 px-4 py-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-slate-400 text-sm truncate">Ylläpitäjä</p>
              </div>
            </div>
          </div>
        </div>
