    ...
    <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-100 text-sm">Haettu automaattisesti rekisterist�</p>
            </div>
          </div>
          {ytjData.is_active ? (
      ...
      <div className="p-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          <div>
            ...
            <dl className="space-y-2">
              ...
              <div className="flex justify-between">
                <dt className="text-slate-600">Rekister�ity:</dt>
          ...
          <div>
            ...
            <dl className="space-y-2">
              <div>
                <dt className="text-slate-600 text-sm">P��toimiala:</dt>
          ...
          {ytjData.visiting_address && (
            <div>
              <h4 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3 flex items-center gap-2">
                <MapPin className="w-4 h-4" /> K�yntiosoite
              </h4>
        ...
        {ytjData.registered_entries && ytjData.registered_entries.length > 0 && (
          <div className="mb-6">
            <h4 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3 flex items-center gap-2">
              <Calendar className="w-4 h-4" /> Rekisterimerkinn�t
            </h4>
