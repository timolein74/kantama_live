...
export default function LandingPage() {
  ...
  // RELEASE FINLAND DEMO: Fixed Raksa Rape Oy details
  const DEMO_COMPANY = {
    company_name: 'Raksa Rape Oy',
    business_id: '3456789-0',
    contact_email: 'rape@raksarape.fi',
  ...
  const leasingForm = useForm<LeasingFormData>({
    ...
    defaultValues: {
      ...
      business_id: DEMO_COMPANY.business_id,
      contact_email: DEMO_COMPANY.contact_email,
      contact_phone: DEMO_COMPANY.contact_phone,
      equipment_price: 50000, // Default demo price
  ...
  const slbForm = useForm<SaleLeasebackFormData>({
    ...
    defaultValues: {
      ...
      contact_email: DEMO_COMPANY.contact_email,
      contact_phone: DEMO_COMPANY.contact_phone,
      current_value: 35000, // Default demo value
      requested_term_months: 36,
  ...
  // DEMO: Tallenna hakemus localStorageen - käytä AINA DEMO_COMPANY arvoja
  const saveDemoApplication = (formData: LeasingFormData | SaleLeasebackFormData, type: 'LEASING' | 'SALE_LEASEBACK') => {
    ...
    const newApp = {
      id: Date.now(),
      reference_number: `RFI-2024-${String(existing.length + 4).padStart(3, '0')}`,
      // DEMO: Käytä aina kiinteitä Raksa Rape Oy arvoja
      company_name: DEMO_COMPANY.company_name,
      business_id: DEMO_COMPANY.business_id,
      contact_email: DEMO_COMPANY.contact_email,
      contact_phone: DEMO_COMPANY.contact_phone,
      equipment_price: 'equipment_price' in formData ? formData.equipment_price : formData.current_value,
      equipment_description: 'equipment_description' in formData 
        ? (formData.equipment_description || formData.additional_info || 'Rahoituskohde') 
        : (formData.additional_info || 'Sale-Leaseback kohde'),
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            readOnly
                            value={DEMO_COMPANY.company_name}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="input bg-slate-100 cursor-not-allowed"
                            readOnly
                            value={DEMO_COMPANY.business_id}
                          />
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="input bg-slate-100 cursor-not-allowed"
                            readOnly
                            value={DEMO_COMPANY.contact_email}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="input bg-slate-100 cursor-not-allowed"
                            readOnly
                            value={DEMO_COMPANY.contact_phone}
                          />
                        </div>
                      </div>
